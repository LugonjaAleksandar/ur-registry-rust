...
typedef NativeConstruct =
    Pointer<Response> Function(Pointer<Utf8>, Pointer<Utf8>, Uint32, Uint32, Pointer<Utf8>, Uint32, Pointer<Utf8>, Pointer<Utf8>);
typedef Construct = Pointer<Response> Function(Pointer<Utf8>, Pointer<Utf8>, int, int, Pointer<Utf8>, int, Pointer<Utf8>, Pointer<Utf8>);
...
class EthSignRequest extends NativeObject {
  ...
  EthSignRequest.factory(List<int> signData, int signType, int chainId, String path, String xfp, String address, String origin) : super() {
    uuid = const Uuid().v4();
